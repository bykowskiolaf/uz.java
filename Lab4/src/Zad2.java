...
public class Zad2 {
    ...
    // method to invert a 2d matrix (flip it upside down, and left to right)
    private static Integer[][] invertMatrix(Integer[][] matrix) {
        Integer[][] invertedMatrix = new Integer[matrix.length][matrix[0].length];
        // loops over all the elements and pushes them to the inverted matrix
        for (int i = 0; i < invertedMatrix.length; i++) {
            for (int j = 0; j < invertedMatrix[i].length; j++) {
                // the element is pushed to the inverted matrix, but the index is inverted
    ...
    public static void main(String[] args) {
        ...
        // this loop generates random numbers from 0 to 100 and pushes them to the numArr
        for (int i = 0; i < numArr.length; i++) {
            ...
            for (int j = 0; j < numArr[i].length; j++) {
                ...
                // this if statement checks if the current random number is bigger than the current maxArrElem
                if (randNumber > maxArrElem) {
                    maxArrElem = randNumber;
                }
                // this if statement checks if the current random number is smaller than the current minArrElem
            ...
            // this loop checks if the current element is bigger or smaller than the average
